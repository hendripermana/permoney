module Accountable
  ...
  TYPES = %w[Depository Investment Crypto Property Vehicle OtherAsset CreditCard Loan OtherLiability PayLater]
  ...
  class_methods do
    ...
    def balance_money(family)
      family.accounts
            ...
            .sum("COALESCE(latest_balance.balance, accounts.balance) * COALESCE(exchange_rates.rate, 1)")
    end
  end
