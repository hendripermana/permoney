class LunchflowItem::Syncer
  ...
  def perform_sync(sync)
    ...
    linked_accounts = lunchflow_item.lunchflow_accounts.select { |account| account.current_account.present? }
    unlinked_accounts = lunchflow_item.lunchflow_accounts.left_joins(:account_provider)
