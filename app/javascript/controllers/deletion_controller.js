...
export default class extends Controller {
  static targets = ["replacementField", "destructiveSubmitButton", "safeSubmitButton"];
  ...
  chooseSubmitButton() {
    if (this.replacementFieldTarget.value) {
      ...
      this.safeSubmitButtonTarget.textContent = this.submitTextWhenReplacingValue;
      this.safeSubmitButtonTarget.hidden = false;
    } else {
      this.destructiveSubmitButtonTarget.textContent = this.submitTextWhenNotReplacingValue;
