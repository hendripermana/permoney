...
export default class extends Controller {
  ...
  updateClock() {
    ...
    if (this.dateTarget.textContent !== formattedDate && this.dateTarget.textContent !== 'Loading...') {
    ...
    if (this.timeTarget.textContent !== formattedTime && this.timeTarget.textContent !== '--:--:--') {
