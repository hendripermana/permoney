...
class Api::V1::CategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should not return other family's categories" do
    ...
    category_names = response_body["categories"].map { |category| category["name"] }
  ...
  test "should return proper category data structure" do
    ...
    category = response_body["categories"].find { |record| record["name"] == @category.name }
  ...
  test "should include parent information for subcategories" do
    ...
    subcategory = response_body["categories"].find { |record| record["name"] == @subcategory.name }
  ...
  test "should sort categories alphabetically" do
    ...
    category_names = response_body["categories"].map { |record| record["name"] }
